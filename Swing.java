...
public class Swing extends JFrame implements ActionListener {
    ...
    public Swing() {
        ...
        for (int i = 0; i < NUMBER_OF_COLORS; i++) {
            int red = 64 + rng.nextInt(150);
            int green = 64 + rng.nextInt(150);
            int blue = 64 + rng.nextInt(150);
        ...
        for (int i = 0; i < NUMBER_OF_COLORS; i++) {
            int red = 32 + rng.nextInt(250);
            int green = 32 + rng.nextInt(250);
            int blue = 32 + rng.nextInt(250);
            Color color = new Color(red, green, blue);
            fgPalette.add(color);
        } // for
